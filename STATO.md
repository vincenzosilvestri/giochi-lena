...
Online: https://vincenzosilvestri.github.io/giochi-lena/ — repo pubblico `vincenzosilvestri/giochi-lena` (GitHub Pages, main). Versione online: **v17**.
...
- Voci: 4979 frasi pre-generate con edge-tts (IT Isabella, FR Denise, DE Katja, EN Sonia, ES Elvira; 69 MB sul server) in `voice/`; `voice/index-<lingua>.json` per lingua: l'app scarica in sottofondo solo le voci delle lingue scelte (cache `lena-voice-1`). Fallback TTS del telefono per nomi delle foto.
